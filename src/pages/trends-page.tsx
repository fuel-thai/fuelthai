...
const SECTIONS: ChartSection[] = [
	...
	{
		title: "FERTILIZER MANUFACTURING PPI",
		titleTh: "ดัชนีราคาผู้ผลิตปุ๋ย",
		subtitle: "US Producer Price Index from FRED (PCU3253132531)",
		subtitleTh: "ดัชนี PPI สหรัฐ จาก FRED",
	...
	{
		title: "PLASTIC RESINS PPI",
		titleTh: "ดัชนีราคาเม็ดพลาสติก",
		subtitle: "US Producer Price Index from FRED (WPU066)",
		subtitleTh: "ดัชนี PPI สหรัฐ จาก FRED",
